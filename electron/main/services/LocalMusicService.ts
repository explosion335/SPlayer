      ...
      const tasks = chunk.map((entry) => {
        return this.limit(async () => {
          ...
          try {
            ...
            const lyricist = metadata.common.lyricist;
            const arranger = metadata.common.arranger;
            ...
            const track: MusicTrack = {
              ...
              composer: Array.isArray(composer) ? composer.join(" / ") : composer,
              lyricist: Array.isArray(lyricist) ? lyricist.join(" / ") : lyricist,
              arranger: Array.isArray(arranger) ? arranger.join(" / ") : arranger,
              producer: Array.isArray(producer) ? producer.join(" / ") : producer,
            };
